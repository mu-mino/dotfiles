...
const SHORT_SHA_DOCS_URL = "https://docs.github.com/en/actions/security-guides/security-hardening-for-github-actions#using-third-party-actions";
/**
 * Checks if a ref looks like a short SHA and adds a warning if so.
 * Returns true if a warning was added.
 */
export function warnIfShortSha(diagnostics, token, ref) {
 ...
 * - {owner}/{repo}/{path}@{ref}
 */
export function validateStepUsesFormat(diagnostics, token) {
...
//# sourceMappingURL=validate-uses.js.map