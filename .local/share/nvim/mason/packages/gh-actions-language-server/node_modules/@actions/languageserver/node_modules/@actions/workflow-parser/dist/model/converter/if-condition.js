...
import { Binary, FunctionCall, Grouping, IndexAccess, Logical, Unary } from "@actions/expressions/ast";
import { splitAllowedContext } from "../../templates/allowed-context.js";
import { BasicExpressionToken, ExpressionToken } from "../../templates/tokens/index.js";
/**
 ...
 */
export function ensureStatusFunction(condition, definitionInfo) {
 ...
 */
export function convertToIfCondition(context, token) {
