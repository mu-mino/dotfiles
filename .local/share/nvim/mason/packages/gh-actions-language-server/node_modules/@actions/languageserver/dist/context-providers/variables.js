...
export async function getRemoteVariables(octokit, cache, repo, environmentName) {
    ...
    return {
        ...
        environmentVariables: (environmentName &&
            (await cache.get(`${repo.owner}/${repo.name}/vars/environment/${environmentName}`, undefined, () => fetchEnvironmentVariables(octokit, repo.owner, repo.name, environmentName)))) ||
            [],
...
async function fetchEnvironmentVariables(octokit, owner, name, environmentName) {
    try {
