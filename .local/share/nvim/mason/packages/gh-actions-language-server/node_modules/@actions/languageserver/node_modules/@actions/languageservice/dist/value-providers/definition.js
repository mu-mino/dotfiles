 ...
 */
export function definitionValues(def, indentation, mode, tokenStructure, schema) {
 ...
 */
function oneOfValues(oneOfDefinition, definitions, indentation, mode, tokenStructure, schema) {
    const values = [];
