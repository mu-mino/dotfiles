...
async function getRemoteSecrets(octokit, cache, repo, environmentName) {
    return {
        ...
        environmentSecrets: (environmentName &&
            (await cache.get(`${repo.owner}/${repo.name}/secrets/environment/${environmentName}`, undefined, () => fetchEnvironmentSecrets(octokit, repo.owner, repo.name, environmentName)))) ||
            [],
...
async function fetchEnvironmentSecrets(octokit, owner, name, environmentName) {
    try {
