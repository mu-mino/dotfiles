...
import { isBasicExpression, isBoolean, isMapping, isString } from "@actions/workflow-parser";
 ...
 */
function validateConcurrencyQueueCancelInProgress(diagnostics, template) {
...
function checkConcurrencyQueueConflict(diagnostics, token) {
    if (!isMapping(token)) {
        return;
    }
