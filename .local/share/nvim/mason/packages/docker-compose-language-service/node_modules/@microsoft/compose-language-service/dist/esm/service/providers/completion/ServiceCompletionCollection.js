...
export const ServiceCompletionCollection = new CompletionCollection('service', { logicalPaths: [PositionAtServicePathRegex, PositionInServiceKeyPathRegex], indentationDepth: 2 }, ...[
    {
        label: 'build:',
