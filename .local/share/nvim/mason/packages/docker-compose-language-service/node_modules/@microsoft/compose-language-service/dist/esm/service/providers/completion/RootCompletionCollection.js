...
export const RootCompletionCollection = new CompletionCollection('root', { logicalPaths: [PositionAtRootPathRegex, PositionInRootKeyPathRegex], indentationDepth: 0 }, ...[
    {
        label: 'configs:',
        insertText: 'configs:\n',
