...
export const BuildCompletionCollection = new CompletionCollection('build', { logicalPaths: [PositionAtBuildPathRegex, PositionInBuildKeyPathRegex], indentationDepth: 3 }, ...[
    {
        label: 'args:',
        insertText: 'args:\n\t- ${1:name}=${2:value}$0',
