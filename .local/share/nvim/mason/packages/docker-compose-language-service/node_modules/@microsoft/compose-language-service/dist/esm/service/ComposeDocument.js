...
import { isDocument, parseDocument } from 'yaml';
import { CRLF, DocumentSettingsRequest, LF } from '../common/DocumentSettingsClientCapabilities';
...
export class ComposeDocument {
    yamlDocument = new Lazy(() => this.buildYamlDocument());
    documentSettings;
